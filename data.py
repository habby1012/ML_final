...
with open('html.2023.final.data/sno_test_set.txt') as file:
    sno_test = [line.strip() for line in file]

All_date = os.listdir("html.2023.final.data/release/")
...
for date in All_date:
    for sno in sno_test:
        ...
        json_file = "html.2023.final.data/release/" + date + "/" + sno + ".json"
